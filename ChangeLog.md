...
* `stack ghci` builds the project before launching GHCi.  If the build fails, optimistically launch GHCi anyway [#1065](https://github.com/commercialhaskell/stack/issues/1065)
